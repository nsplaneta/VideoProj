...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/SubscriptionFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/UserFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/VideosFixtures.php';

        $a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($container);
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoriesFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CommentsFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\SubscriptionFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\VideosFixtures(), 'groups' => []]]);
