...
/* base.html.twig */
class __TwigTemplate_84ec9415f8ee8c60ebc1f0eb96c1943aba1a0b5451692c371c4448daf25ebe58 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "VideoProj - Videos hosting and sharing service";
    ...
    <div class=\"text-left float-left\">
        ...
        echo "\">
            ...
            <button class=\"btn btn-outline-violet-light my-2 my-sm-0\" type=\"submit\">Search video</button>
        </form>
    ...
    <div class=\"container\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navbarResponsive\">
            <ul class=\"navbar-nav ml-auto\">
                ";
        // line 38
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("App\\Controller\\FrontController::categoriesList", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 38, $this->source); })()), "request", [], "any", false, false, false, 38), "get", [0 => "id"], "method", false, false, false, 38)]));
        echo "
                ";
        // line 39
...
<footer class=\"py-5 bg-dark\">
    <div class=\"container\">
        <p class=\"m-0 text-center text-white\">Copyright &copy; VideoProj 2020</p>
    </div>
    <!-- /.container -->
</footer>
";
    ...
    {
        return array (  281 => 76,  264 => 65,  254 => 64,  236 => 62,  222 => 56,  216 => 53,  210 => 50,  207 => 49,  200 => 45,  191 => 41,  188 => 40,  186 => 39,  182 => 38,  167 => 26,  156 => 18,  152 => 16,  142 => 15,  123 => 11,  105 => 9,  93 => 77,  91 => 76,  86 => 73,  84 => 64,  81 => 63,  79 => 62,  76 => 61,  74 => 15,  69 => 12,  67 => 11,  64 => 10,  62 => 9,  56 => 6,  49 => 1,);
    }
...
<head>
    ...
    <title>
        {% block title %}VideoProj - Videos hosting and sharing service{% endblock %}
    </title>
</head>
<body>
{% block menu %}
<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark fixed-top\">
    <div class=\"text-left float-left\">
        ...
        <form method=\"GET\" class=\"form-inline my-0 mr-md-auto\" action=\"{{ path('search')}}\">
            <input name=\"query\" class=\"form-control mr-sm-2\" type=\"search\" placeholder=\"video title\" aria-label=\"Search video\">
            <button class=\"btn btn-outline-violet-light my-2 my-sm-0\" type=\"submit\">Search video</button>
        </form>
        <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarResponsive\" aria-controls=\"navbarResponsive\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
    ...
    <div class=\"container\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navbarResponsive\">
            <ul class=\"navbar-nav ml-auto\">
                {{ render(controller(\"App\\\\Controller\\\\FrontController::categoriesList\", { 'id': app.request.get('id') })) }}
                {% if app.user %}
                        <li class=\"nav-link admin\">
                            <a href=\"{{ path('admin_profile')}}\">@{{ app.user.name }}
                            </a>
                        </li>
                    <li class=\"nav-link admin\">
                        <a href=\"{{ path('logout')}}\"> Logout
                        </a>
                    </li>
                {% else %}
                        <li class=\"nav-link admin\">
...
", "base.html.twig", "/home/nico/Shared/PhpstormProjects/MetubeMaster/Metub/templates/base.html.twig");
    }
}
