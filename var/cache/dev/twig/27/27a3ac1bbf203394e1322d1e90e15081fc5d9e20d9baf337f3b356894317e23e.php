...
class __TwigTemplate_6de4d99e0b1030d000332cea0a9c8687d916ebe56948347d25a4cd79ac84db46 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center\">
    <h1 class=\"display-4 py-5\">Pricing</h1>
...
<div class=\"container\">
    <div class=\"card-deck mb-3 text-center\">
        ...
        echo "\" class=\"btn btn-lg btn-block btn-outline-violet\">Sign up for free</a>
            </div>
        </div>
        <div class=\"card mb-4 shadow-sm\">
            <div class=\"card-header\">
        ...
        echo "\" class=\"btn btn-lg btn-block btn-violet\">Get started</a>
            </div>
        </div>
        <div class=\"card mb-4 shadow-sm\">
            <div class=\"card-header\">
        ...
        echo "\" class=\"btn btn-lg btn-block btn-violet\">Contact us</a>
            </div>
        </div>
    </div>
    ...
    <div class=\"card-deck mb-3 text-center\">
        <div class=\"card mb-4 shadow-sm\">
            ...
            <div class=\"card-body\">
                ...
                <a role=\"button\" href=\"{{ path('register', {'plan':name[0]})}}\" class=\"btn btn-lg btn-block btn-outline-violet\">Sign up for free</a>
            </div>
        </div>
        <div class=\"card mb-4 shadow-sm\">
            <div class=\"card-header\">
            ...
            <div class=\"card-body\">
                ...
                <a role=\"button\" href=\"{{ path('register', {'plan':name[1]}) }}\" class=\"btn btn-lg btn-block btn-violet\">Get started</a>
            </div>
        </div>
        <div class=\"card mb-4 shadow-sm\">
            <div class=\"card-header\">
            ...
            <div class=\"card-body\">
                ...
                <a role=\"button\" href=\"{{ path('register', {'plan':name[2]})}}\" class=\"btn btn-lg btn-block btn-violet\">Contact us</a>
            </div>
        </div>
    </div>
...
{% endblock %}", "front/pricing.html.twig", "/home/nico/Shared/PhpstormProjects/MetubeMaster/Metub/templates/front/pricing.html.twig");
    }
}
